...
/// </summary>
public class CreateExternalAuthenticatorRequest
{
  /// <summary>
  ...
  public ExternalAuthenticators? Provider { get; set; }
  ...
  /// </summary>
  public TrustEmailModes? TrustEmail { get; set; }
  ...
  /// </summary>
  public CreateExternalAuthenticatorCredentialsRequest? Credentials { get; set; }
  ...
  /// </summary>
  public CreateExternalAuthenticatorConnectionRequest? Connection { get; set; }
  ...
  /// </summary>
  public List<SigningAlgorithms>? AllowedSigningAlgorithms { get; set; }
