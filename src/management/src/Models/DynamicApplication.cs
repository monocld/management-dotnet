...
/// <summary>
/// DynamicApplication: Represents a client application created through dynamic client registration.
/// </summary>
public class DynamicApplication
{
  ...
  /// <summary>
  /// When set, the UserInfo endpoint returns a signed JWT (application/jwt) using this algorithm instead of a JSON object.
  /// </summary>
  public SigningAlgorithms? UserInfoSignedResponseAlgorithm { get; set; }
  ...
  /// <summary>
  /// The subject identifier type used when issuing the &#x60;sub&#x60; claim to this client (public or pairwise).
  /// </summary>
  public SubjectTypes SubjectType { get; set; }

  /// <summary>
  /// The resolved sector host used to compute pair-wise subject identifiers. Only set for clients with the pairwise subject type.
  /// </summary>
  public string? SectorIdentifier { get; set; }

  /// <summary>
  /// The URI of the client&#39;s JSON Web Key Set, fetched at runtime to validate private_key_jwt client assertions and signed request objects.
  /// </summary>
  ...
  /// <summary>
  /// The metadata document the client was dynamically registered with, as JSON.
  /// </summary>
  public string RegistrationDocument { get; set; }

  /// <summary>
  /// The name of the registration profile the client was registered under.
  /// </summary>
