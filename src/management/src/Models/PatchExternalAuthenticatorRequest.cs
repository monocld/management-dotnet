...
/// </summary>
[JsonConverter(typeof(PatchConverter<PatchExternalAuthenticatorRequest>))]
public class PatchExternalAuthenticatorRequest
{
  /// <summary>
  ...
  /// </summary>
  public Optional<TrustEmailModes> TrustEmail { get; set; }
  ...
  /// </summary>
  public Optional<PatchExternalAuthenticatorCredentialsRequest?> Credentials { get; set; }

  /// <summary>
  /// The protocol connection settings used to communicate with the external identity provider.
  /// </summary>
  public Optional<PatchExternalAuthenticatorConnectionRequest?> Connection { get; set; }
  ...
  public Optional<List<SigningAlgorithms>?> AllowedSigningAlgorithms { get; set; }
