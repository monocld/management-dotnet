...
/// </summary>
[JsonConverter(typeof(PatchConverter<PatchPkiTrustStoreRequest>))]
public class PatchPkiTrustStoreRequest
{
  /// <summary>
  ...
  /// </summary>
  public Optional<PatchPkiTrustStoreOptionsRequest> Options { get; set; }
}
